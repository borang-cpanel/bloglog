 ...
 * @package Bloglog
 */
if ( !function_exists('bloglog_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function bloglog_category_widgets(){
        // Recent Post widget.
        register_widget('Bloglog_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'bloglog_category_widgets');
// Recent Post widget
if ( !class_exists('Bloglog_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class Bloglog_Sidebar_Category_Widget extends Bloglog_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'bloglog_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'bloglog'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'bloglog'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'bloglog'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_label' => array(
                    'label'         => esc_html__('Latest Label', 'bloglog'),
                    'type'          => 'text',
                    'default'          => esc_html__('Latest:', 'bloglog'),
                ),
            );
            parent::__construct('bloglog-category-layout', esc_html__('MP: Category Widget', 'bloglog'), $opts, array(), $fields);
        }
        /**
