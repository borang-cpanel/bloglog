(function ($) {
    ...
    var ajaxurl = bloglog_admin.ajax_url;
    var BloglogNonce = bloglog_admin.ajax_nonce;

    // Category Color
    $('#bloglog-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: bloglog_admin.upload_image,
            button: {
            text: bloglog_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'bloglog_notice_dismiss',
            '_wpnonce': BloglogNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-bloglog-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-bloglog-notice').addClass('twp-installing');

        var data = {
            'action': 'bloglog_install_plugins',
            '_wpnonce': BloglogNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = bloglog_admin.active
            var deactivate = bloglog_admin.deactivate
